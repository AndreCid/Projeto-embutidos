...
(cl:defmethod cl:initialize-instance :after ((m <TemperatureArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TemperatureArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name schunk_sdh-msg:<TemperatureArray> is deprecated: use schunk_sdh-msg:TemperatureArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <TemperatureArray>))
...
(cl:defmethod name-val ((m <TemperatureArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader schunk_sdh-msg:name-val is deprecated.  Use schunk_sdh-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'temperature-val :lambda-list '(m))
(cl:defmethod temperature-val ((m <TemperatureArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader schunk_sdh-msg:temperature-val is deprecated.  Use schunk_sdh-msg:temperature instead.")
  (temperature m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TemperatureArray>)))
  ...
  (cl:format cl:nil "Header header~%~%string[] name           # list of sensor name~%float64[] temperature   # list of temperature in degree Celcius (°C)~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TemperatureArray)))
  "Returns full string definition for message of type 'TemperatureArray"
  (cl:format cl:nil "Header header~%~%string[] name           # list of sensor name~%float64[] temperature   # list of temperature in degree Celcius (°C)~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
